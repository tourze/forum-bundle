...
#[AsCommand(name: self::NAME, description: '计算帖子分享统计指标排名')]
final class UpdateThreadVisitStatShareRankCommand extends LockableCommand
{
    public const NAME = 'forum:update-thread-stat-share-rank';

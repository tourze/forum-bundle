...
use ForumBundle\Command\UpdateThreadVisitStatCommentRankCommand;
...
#[CoversClass(UpdateThreadVisitStatCommentRankCommand::class)]
final class UpdateThreadVisitStatCommentRankCommandTest extends AbstractCommandTestCase
{
    ...
    protected function onSetUp(): void
    {
        ...
        $command = self::getContainer()->get(UpdateThreadVisitStatCommentRankCommand::class);
        self::assertInstanceOf(UpdateThreadVisitStatCommentRankCommand::class, $command);
    ...
    public function testCommandShouldHaveCorrectName(): void
    {
        ...
        $this->assertSame('forum:update-thread-stat-comment-rank', $command->getName());
    }

...
use ForumBundle\Event\AfterCreateOfficialThreadEvent;
 ...
 * @internal
 */
#[CoversClass(AfterCreateOfficialThreadEvent::class)]
final class AfterCreateOfficialThreadEventTest extends AbstractEventTestCase
{
    public function testConstructorWorksWithoutParameters(): void
    {
        $event = new AfterCreateOfficialThreadEvent();
        $this->assertInstanceOf(AfterCreateOfficialThreadEvent::class, $event);
    }
